...
namespace LightLib.Web.Controllers
{
    ...
    public class PatronController : LibraryController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddPatron(PatronDto patron)
        {
            
            await _patronService.Add(patron);
        ...
        {
            await _patronService.Delete(id);
            return RedirectToAction("Index");

        }

        [HttpPost]
        public async Task<IActionResult> EditPatron(PatronDto patron)
        {
            await _patronService.UpdatePatron(patron);
            return RedirectToAction("Index");
        }
    }
}